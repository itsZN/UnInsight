  ...
  <body>
    ...
    <div class="container">
      <div class="list-group">
		...
		?>
        <a href="#" class="list-group-item active"><center><?php echo $row['name'];?></center></a>
		<?php 
			
			$result = mysqli_query($con,"SELECT * FROM `threads` WHERE forum=".$_GET['fid']." ORDER BY lastPost DESC");
